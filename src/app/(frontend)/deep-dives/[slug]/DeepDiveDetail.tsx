...
export default function DeepDiveDetail({ initialData, serverURL }: { initialData: any; serverURL: string }) {
  const { data: dive } = useLivePreview({
    initialData,
    serverURL,
    depth: 1,
  })
  ...
  const tags: string[] = Array.isArray(dive.tags) ? dive.tags.filter(Boolean) : []
  ...
  return (
    <div className="container">
      <div className="post-layout">
        <Link href="/deep-dives/" className="post-back">
